...
export default function PortfolioPage() {
  const projects = [
    ...
    },
    {
      ...
      description: "Comprehensive social media strategy and content creation for a major corporate brand."
    },
    {
      title: "Product Launch Campaign",
      category: "Event Management",
      image: "https://images.unsplash.com/photo-1505373877841-8d25f7d46678",
      description: "Successful product launch event with over 500 attendees and extensive media coverage."
    },
    {
      title: "Tech Conference Production",
      category: "Audiovisual",
      image: "https://images.unsplash.com/photo-1505373877841-8d25f7d46678",
      description: "Full audiovisual production for a major tech conference with live streaming capabilities."
    },
    {
      title: "Marketing Materials Suite",
      category: "Print Services",
      image: "https://images.unsplash.com/photo-1557425955-df376b5903c8",
      description: "Comprehensive print materials including brochures, business cards, and large format displays."
    },
    {
      title: "Office Network Infrastructure",
      category: "Network Solutions",
      image: "https://images.unsplash.com/photo-1558494949-ef010cbdcc31",
      description: "Complete network infrastructure setup for a 200-person office space."
    }
  ];
  ...
  return (
    <div className="container mx-auto px-4 py-16">
      ...
      <h1 className="text-4xl font-bold mb-6 text-primary">Our Portfolio</h1>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        {projects.map((project) => (
          <div key={project.title} className="bg-card rounded-lg overflow-hidden shadow-sm">
